...
class AssetManager:
    ...
    def get_asset(self, asset_description, failure_mode, asset_type="video"):
        ...
        if failure_mode == 0:
            ...
            extension = ".mp3" if asset_type == "music" else ".mp4"
        ...
        if asset_type == "music":
             return {
                ...
                "description": "Tension Soundscape (Low Frequency)",
                "layer_used": "Layer 3 (Procedural Backup)"
            }
        else:
            # Generates simple data structure for VIDEO
            return {
                "source": "procedural",
                "type": "solid_color",
...
class JSONBuilder:
    ...
    def build_blueprint(self, script_text, style_preset_name, failure_mode):
        ...
        # Global Audio Track (Resilience Check)
