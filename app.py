...
style_preset = st.sidebar.radio(
    ...
    help="Controls the pacing and aesthetic of the generated video."
)
...
script_input = st.sidebar.text_area(
    ...
    height=150,
    help="Enter the voiceover script. The engine splits segments by periods."
)
...
failure_mode_label = st.sidebar.radio(
    ...
    help="Simulate different system failure levels to test resilience."
)
