...
script_input = st.sidebar.text_area(
    ...
    height=150,
    help="The text script that will be segmented into video scenes."
)
...
failure_mode_label = st.sidebar.radio(
    ...
    help="Simulate different failure scenarios to test resilience layers."
)
...
if st.button("Generate Blueprint & Simulate Render", type="primary", use_container_width=True):
    ...
    with st.expander("View JSON Blueprint", expanded=False):
