...
style_preset = st.sidebar.radio(
    ...
    help="Choose the visual and auditory style for the generated content."
)
...
script_input = st.sidebar.text_area(
    ...
    height=150,
    help="Enter the text script to be visualized. Sentences will be segmented."
)
...
failure_mode_label = st.sidebar.radio(
    ...
    help="Simulate different failure scenarios to test system resilience."
)
