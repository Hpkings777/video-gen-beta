...
style_preset = st.sidebar.radio(
    ...
    help="Select the visual and pacing style for the generated video.",
)
...
script_input = st.sidebar.text_area(
    ...
    height=150,
    help="Enter the text to be visualized. Sentences define scene segmentation.",
)
...
failure_mode_label = st.sidebar.radio(
    ...
    help="Simulate different system failure levels to test resilience layers.",
)
...
if st.button(
    "Generate Blueprint & Simulate Render", type="primary", use_container_width=True
):
