...
style_preset = st.sidebar.radio(
    ...
    help="Select the visual style for the generated video."
)

# Script Input
default_script = "Coffee is life. Energy flows through the veins. The world wakes up."
script_input = st.sidebar.text_area("Script Input", value=default_script, height=150, help="Enter the script text to be converted into video segments.")
